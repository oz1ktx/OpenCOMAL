/****************************************************************************
** Meta object code from reading C++ file 'file_browser_panel.h'
**
...
#include "../../../../comal-ide/include/file_browser_panel.h"
...
#error "The header file 'file_browser_panel.h' doesn't include <QObject>."
...
void FileBrowserPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FileBrowserPanel::*)(const QString & )>(_a, &FileBrowserPanel::fileDoubleClicked, 0))
            return;
    }
}
