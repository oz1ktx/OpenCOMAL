...
void RunWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->suspended((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->variablesChanged((*reinterpret_cast<std::add_pointer_t<QVariantList>>(_a[1]))); break;
        case 5: _t->callStackChanged((*reinterpret_cast<std::add_pointer_t<QVariantList>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (RunWorker::*)()>(_a, &RunWorker::sceneChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (RunWorker::*)(int )>(_a, &RunWorker::suspended, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (RunWorker::*)(const QVariantList & )>(_a, &RunWorker::variablesChanged, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (RunWorker::*)(const QVariantList & )>(_a, &RunWorker::callStackChanged, 5))
            return;
    }
}
...
// SIGNAL 3
void RunWorker::suspended(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 3, nullptr, _t1);
}

// SIGNAL 4
void RunWorker::variablesChanged(const QVariantList & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 4, nullptr, _t1);
}

// SIGNAL 5
void RunWorker::callStackChanged(const QVariantList & _t1)
{
